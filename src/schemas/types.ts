...
import { getCheckoutFormSchema, getContactSchema, getCoverLetterFormSchema, getCreditCardSchema, getLoginSchema, getNewPasswordSchema, getRegisterSchema, getResetSchema, getResumeDetailsSchema, getResumeFormSchema, getResumeInfoSchema, getResumeOptionalDetailsSchema, getDocStyleSchema, getCoverLetterInfoSchema, getCoverLetterDetailsSchema, getSettingsSchema } from "."
...
// Subscription Form
export type CheckoutFormType = z.infer<
     Awaited<ReturnType<typeof getCheckoutFormSchema>>
>
export type CreditCardType = z.infer<
     Awaited<ReturnType<typeof getCreditCardSchema>>
>