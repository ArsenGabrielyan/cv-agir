...
const auditLogTranslations = {
     "audit-log-keywords": {
          ...
          subscription: {
               CREDIT_CARD_ADDED: "%{username}-ը ավելացրել է նոր վարկային քարտ։",
               CREDIT_CARD_UPDATED: "%{username}-ը փոխել է վարկային քարտի տվյալները։",
               CREDIT_CARD_DELETED: "%{username}-ը հեռացրել է վարկային քարտի տվյալները։",
               PLAN_UPGRADED: "%{username}-ը անցել է պրեմիում տարբերակի։",
               PLAN_CANCELLED: "%{username}-ը անցել է անվճար տարբերակի։",
               PLAN_RENEWED: "%{username}-ը վերանայել է պրեմիում տարբերակը։"
          },
          ai: {
     ...
     "audit-log-secondary-texts": {
          ...
          subscription: {
               creditCard: "IP՝ %{ip}, Վարկային քարտի համար՝ **** **** **** %{last4}",
               default: "IP՝ %{ip}",
               defaultError: "IP՝ %{ip}, Պատճառ՝ %{reason}"
          },
          ai: {
