...
const auditLogTranslations = {
     "audit-log-keywords": {
          ...
          subscription: {
               CREDIT_CARD_ADDED: "%{username} has added a new credit card.",
               CREDIT_CARD_UPDATED: "%{username} has changed credit card information.",
               CREDIT_CARD_DELETED: "%{username} has removed credit card information.",
               PLAN_UPGRADED: "%{username} has upgraded to premium.",
               PLAN_CANCELLED: "%{username} has upgraded to free.",
               PLAN_RENEWED: "%{username} has reviewed premium."
          },
          ai: {
     ...
     "audit-log-secondary-texts": {
          ...
          subscription: {
               creditCard: "IP: %{ip}, Credit Card Number: **** **** **** %{last4}",
               default: "IP: %{ip}",
               defaultError: "IP: %{ip}, Reason: %{reason}"
          },
          ai: {
