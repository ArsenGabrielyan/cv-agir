...
export const AuditLogsList = () => (
     <InfiniteList filters={logFilters}>
          <SimpleList
               ...
               primaryText={(record: AuditLogServerData)=>formatAuditLogData(record).primaryText}
               secondaryText={(record: AuditLogServerData)=>formatAuditLogData(record).secondaryText}
               tertiaryText={(record: AuditLogServerData)=>formatDistanceToNow(record.createdAt,{
                    locale: hy
               })}
          />
     </InfiniteList>
